...
export async function syncPhongGiuong() {
  ...
  if (err3) throw err3;
  // Chỉ đánh dấu giường đã sử dụng khi cọc đã được xác nhận. Phiếu được Quản lý
  // xác nhận còn trống chỉ giữ giường trong KhoaGiuongDatCoc, chưa đổi TinhTrang vật lý.
